...
def BEST_LDA(data_vectorized,tweets,vectorizer):
    ...
    df_document_topic.to_csv("Dominant_Topic1.csv")
    ...
    df_topic_distribution.to_csv("Topic_Distribution1.csv")
    ...
    df_topic_keywords.to_csv("Topic_Keywords1.csv")
...
print ("\n \n TOPIC KEYWORDS LDA \n\n")
print (df_topic_keywords)
df_topic_keywords.to_csv("topic_keywords_LDA_NEW1.csv")


'''
To find maximum of each topic in a tweet.
bhu=[]
